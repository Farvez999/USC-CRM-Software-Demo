                ...
                user?.role === "admin" && <>
                    ...
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        <li className="rounded-sm">
                            <NavLink rel="noopener noreferrer" to={`/dashboard`} className="flex items-center p-2 space-x-3 rounded-md">
                        ...
                        <li className="rounded-sm">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/lead-upload`} className={({ isActive }) =>
                        ...
                        <li className="rounded-sm">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/total-leads`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/total-close`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/online-students`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/offline-students`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/seminar-interesteds`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/seminar-attends`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/total-no-receive`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                        ...
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/today-followUps`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                    ...
                    <ul className="pt-4 pb-2 space-y-1 text-sm">
                        <li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
                            <NavLink rel="noopener noreferrer" to={`/dashboard/admin-pay-details`} className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                            }>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <span className='text-xs'>Date Wise Collection</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                    ...
                                    <li><NavLink className={({ isActive }) =>
                                        ...
                                        <span className='text-xs'>PayGetway Report</span></NavLink></li>
                                </ul>
                            </details>
                        </li>
                        <li>
                            <details>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                        } to={`/dashboard/collection/head`}>
                                            <img width="16" height="16" src="https://img.icons8.com/fluency/48/pay-date.png" alt="pay-date" />
                                            <span className='text-xs'>Collection Head</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <span className='text-xs'>Add Collection</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <span className='text-xs'>Collection</span></NavLink>
                                    </li>
                                </ul>
                            </details>
                        </li>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <span className='text-xs'>Date Wise Report</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <span className='text-xs'>Money Receipt</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <span className='text-xs'>Head Wise Report</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <span className='text-xs'>PayGetway Report</span></NavLink>
                                    </li>
                                </ul>
                            </details>
                        </li>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/fluency/48/pay-date.png" alt="pay-date" />
                                            <span className='text-xs'>Expense Head</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/stickers/100/batch-assign.png" alt="batch-assign" />
                                            <span className='text-xs'>Add Expense</span></NavLink>
                                    </li>
                                    <li><NavLink className={({ isActive }) =>
                                        isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                    } to={`/dashboard/expense/expense`}>
                                        <img width="16" height="16" src="https://img.icons8.com/color-glass/48/profit-report.png" alt="profit-report" />
                                        <span className='text-xs'>Expense</span></NavLink></li>
                                </ul>
                            </details>
                        </li>
                        <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/stickers/100/batch-assign.png" alt="batch-assign" />
                                            <span className='text-xs'>Voucher No Wise Report</span></NavLink>
                                    </li>
                                    <li><NavLink className={({ isActive }) =>
                                        isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                    } to={`/dashboard/expense/purpose`}>
                                        <img width="16" height="16" src="https://img.icons8.com/color-glass/48/profit-report.png" alt="profit-report" />
                                        <span className='text-xs'>Head Wise Report</span></NavLink></li>
                                </ul>
                            </details>
                        </li>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/fluency/48/pay-date.png" alt="pay-date" />
                                            <span className='text-xs'>Loan Head</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/color/48/pay-date.png" alt="pay-date" />
                                            <span className='text-xs'>Loan Payable</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/officel/16/mobile-payment.png" alt="mobile-payment" />
                                            <span className='text-xs'>All Payable</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/arcade/64/health-graph.png" alt="health-graph" />
                                            <span className='text-xs'>Loan Receiveable</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/color-glass/48/download-graph-report.png" alt="download-graph-report" />
                                            <span className='text-xs'>All Receiveable</span></NavLink>
                                    </li>
                                </ul>
                            </details>
                        </li>
                                ...
                                <ul>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/color/48/pay-date.png" alt="pay-date" />
                                            <span className='text-xs'>Course Name</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/officel/16/mobile-payment.png" alt="mobile-payment" />
                                            <span className='text-xs'>Batch Name</span></NavLink>
                                    </li>
                                    {/* <li>
                                                            <NavLink className={({ isActive }) =>
                                isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                                    ...
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            ...
                                            <img width="16" height="16" src="https://img.icons8.com/color-glass/48/download-graph-report.png" alt="download-graph-report" />
                                            <span className='text-xs'>User & Head</span></NavLink>
                                    </li>
                                    <li>
                                        <NavLink className={({ isActive }) =>
                                            isActive ? "text-green-400 flex items-center p-2 space-x-3 rounded-md" : " flex items-center p-2 space-x-3 rounded-md"
                    ...
                    <li className="rounded-sm">
                        ...
                        <NavLink rel="noopener noreferrer" to="#" className="flex items-center p-4 space-x-3 rounded-md text-red-500 font-bold">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
