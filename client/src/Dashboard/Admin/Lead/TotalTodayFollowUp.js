            ...
            <nav aria-label="breadcrumb" className="w-full p-4 dark:bg-gray-800 dark:text-gray-100">
                <ol className="flex h-8 space-x-2">
                    ...
                    <li className="flex items-center space-x-2">
                        ...
                        <a rel="noopener noreferrer" href="#" className="flex items-center px-1 capitalize hover:underline">Total  Follow up Students</a>
                    </li>
                </ol>
            </nav>
                    ...
                    <form>
                        <table className="table w-full">
                            ...
                            <tbody className='w-fit text-xs'>
                                {
                                    filterData.length > 0 &&
                                    filterData?.filter(ttodayf => {
                                        return search?.toLowerCase() === '' ? ttodayf : ttodayf.name.toLowerCase().includes(search?.toLowerCase()) || ttodayf?.email?.toLowerCase().includes(search?.toLowerCase()) || ttodayf.phone.toLowerCase().includes(search?.toLowerCase())
                                    })?.map((ttodayf, i) =>
                                        <tr key={ttodayf._id}>
                                            <th className='p-1 border-2'>{i + 1}</th>
                                            <td className='p-1 border-2'>{ttodayf.createdAt.slice(0, -14)}</td>
                                            ...
                                            <td className='p-1 border-2'>
                                                <p className='btn btn-xs btn-denger' onClick={() => handleDelete(ttodayf._id)} >Delete</p>
                                            </td>
                                        </tr>
                                    )
                                }
