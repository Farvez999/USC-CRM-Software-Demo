            ...
            <nav aria-label="breadcrumb" className="w-full p-4 dark:bg-gray-800 dark:text-gray-100">
                <ol className="flex h-8 space-x-2">
                    ...
                    <li className="flex items-center space-x-2">
                        ...
                        <a rel="noopener noreferrer" href="#" className="flex items-center px-1 capitalize hover:underline">Total Close Students</a>
                    </li>
                </ol>
            </nav>
                            ...
                            <tbody className='w-fit text-xs'>
                                {
                                    ...
                                    filterData?.filter(close => {
                                        return search?.toLowerCase() === '' ? close : close.name.toLowerCase().includes(search?.toLowerCase()) || close.email?.toLowerCase().includes(search?.toLowerCase()) || close.phone.toLowerCase().includes(search?.toLowerCase())
                                    })?.map((close, i) =>
                                        <tr key={close._id}>
                                            <th className='p-1 border-2'>{i + 1}</th>
                                            <td className='p-1 border-2'>{close.createdAt.slice(0, -14)}</td>
                                            ...
                                            <td className='p-1 border-2'>
                                                <p className='btn btn-xs btn-denger' onClick={() => handleDelete(close._id)} >Delete</p>
                                            </td>
                                        </tr>
                                    )
                                }
