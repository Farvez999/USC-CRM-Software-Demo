...
const OnlineStudents = () => {
    ...
    useEffect(() => {
        fetch("https://demo-usc-crm-server.vercel.app/leads?onlineInterested=true")
    ...
    const uniqueCourse = [...new Set(totalOnline?.map(user => user?.course?.name))];
    ...
    function handleCourseChange(event) {
        ...
        const fData = totalOnline?.filter(si =>
