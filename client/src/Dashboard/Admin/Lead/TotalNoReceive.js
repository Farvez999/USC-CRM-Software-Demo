...
const TotalNoReceive = () => {
    ...
    useEffect(() => {
        fetch("https://demo-usc-crm-server.vercel.app/leads?noReceive=true")
    ...
    const uniqueCourse = [...new Set(totalNoReceive?.map(user => user?.course?.name))];
    ...
    function handleCourseChange(event) {
        ...
        const fData = totalNoReceive?.filter(si =>
